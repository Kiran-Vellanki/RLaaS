...
// RateLimitFilter filter = new RateLimitFilter(new
// CountingRateLimiterService(5));
...
// sixthRequest.getResponse().getStatusCode());
// assertEquals("60",
// sixthRequest.getResponse().getHeaders().getFirst("Retry-After"));
// assertEquals("5",
// sixthRequest.getResponse().getHeaders().getFirst("X-RateLimit-Limit"));
// assertEquals("0",
// sixthRequest.getResponse().getHeaders().getFirst("X-RateLimit-Remaining"));
// }
